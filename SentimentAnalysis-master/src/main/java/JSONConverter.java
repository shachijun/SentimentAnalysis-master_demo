...
public class JSONConverter {
    ...
    public static void main(String[] args) throws IOException, JSONException {
        ...
        BufferedReader br = new BufferedReader(new FileReader("/Users/kevinsha/Desktop/big data/SentimentAnalysis-master/output/part-r-00000"));
        String line = br.readLine();
        FileWriter fileWriter = new FileWriter("/Users/kevinsha/Desktop/big data/SentimentAnalysis-master/output/result.json");
